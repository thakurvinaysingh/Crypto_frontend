...
//       // 3) Re-check user from backend, then persist and redirect
//         try {
//           const res = await checkUserExists(address);
//           if (res?.exists) {
//             const ids = extractIds(res);
...
//             setTimeout(() => nav("/dashboard", { replace: true }), 1500);
//           } else {
//             setErr("Registered but unable to verify user. Please refresh or contact support.");
//           }
//         } catch {
//           setErr("Registered but failed to confirm user ID. Try refreshing.");
//         }
