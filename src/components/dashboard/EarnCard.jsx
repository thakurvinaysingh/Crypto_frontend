  ...
  return (
    <div className="glass p-6 flex items-center justify-between">
      ...
      <button
        ...
        className="hidden sm:inline-grid place-items-center rounded-full h-20 w-20 bg-gradient-to-b from-sky-400 to-sky-500 shadow-[0_18px_35px_rgba(0,0,0,.6)] ring-1 ring-white/20"
      >
        <svg viewBox="0 0 24 24" className="h-10 w-10 text-white">
          <path fill="currentColor" d="M5 12l7-7 7 7-7 7-7-7z" />
        </svg>
      </button>
    </div>
  );
