...
//         <button
//           onClick={disconnect}
//           className="px-3 py-2 rounded-xl bg-white/10 hover:bg-white/15 border border-white/10 text-white/80"
//         >
//           Disconnect
//         </button>
//       </div>
...
//       whileTap={{ scale: 0.98 }}
//       onClick={onOpen}
//       className="inline-flex items-center gap-3 px-5 py-3 rounded-2xl bg-gradient-to-r from-[#5BB8FF] to-[#3B82F6] text-white font-medium shadow-lg shadow-black/30 ring-1 ring-white/10"
//     >
//       Connect Wallet
//     </motion.button>
//   );
