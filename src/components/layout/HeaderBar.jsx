  ...
  return (
    <>
      <div className="relative w-full rounded-t-[56px] overflow-hidden">
        {/* Background Gradient - UPDATED HEIGHT FOR MOBILE (h-32) */}
        <div
          className="h-32 md:h-24 lg:h-28
          [background:
        ...
        <div className="absolute inset-0">
         ...
         {/* ===== Mobile Header (Below MD) ===== */}
            <div className="md:hidden h-full relative flex flex-col justify-between py-3">
              
              {/* Top Row: Joined Left <---> Logo Right */}
              <div className="flex justify-between items-center px-1">
                
                {/* 1. Left Side: Joined Badge */}
                <div className="px-2 py-1 rounded-2xl bg-white/10 border border-white/10 text-[10px] backdrop-blur-sm">
                  Joined {joinedMobile}
                </div>
